...
export function getChainConfig(chainId: number) {
  const configs: Record<number, { rpcUrl: string; name: string }> = {
    1: { rpcUrl: process.env.ETHEREUM_RPC_URL || "https://eth.llamarpc.com", name: "Ethereum" },
    11155111: { rpcUrl: process.env.ETHEREUM_RPC_URL || "https://rpc.sepolia.org", name: "Sepolia" },
    8453: { rpcUrl: process.env.BASE_RPC_URL || "https://mainnet.base.org", name: "Base" },
    84532: { rpcUrl: process.env.BASE_RPC_URL || "https://sepolia.base.org", name: "Base Sepolia" },
  };
